...
class dataset(Dataset):
    ...
    def __init__(self):
        self.data = self.input_target()

    def __len__(self):
        return 40  # number of images
    ...
    def input_target(self):
        ...
        for i in ['/share4/bayrakrg/tractEM/postprocessing/fib_files/HCP', '/share4/bayrakrg/tractEM/postprocessing/fib_files/BLSA']:
        # ////////////////////////////
    ...
    def __getitem__(self, idx):
        ...
        input = F.interpolate(torch.from_numpy(input).unsqueeze(0),(112,112,112), mode='trilinear').squeeze()
