...
class UNet3D(nn.Module):
    def __init__(self, in_channel, n_classes):
        ...
        self.ec0 = self.encoder(self.in_channel, self.f[0], bias=True, batchnorm=True)
        self.ec1 = self.encoder(self.f[0], self.f[1], bias=True, batchnorm=True)
        self.ec2 = self.encoder(self.f[1], self.f[1], bias=True, batchnorm=True)
        self.ec3 = self.encoder(self.f[1], self.f[2], bias=True, batchnorm=True)
        self.ec4 = self.encoder(self.f[2], self.f[2], bias=True, batchnorm=True)
        ...
        self.dc9 = self.decoder(512, 512, kernel_size=2, stride=2, padding=0, bias=False)
        ...
        self.dc6 = self.decoder(256, 256, kernel_size=2, stride=2, padding=0, bias=False)
        ...
        self.dc3 = self.decoder(128, 128, kernel_size=2, stride=2, padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        e4 = self.ec4(e3)
        syn2 = self.ec5(e4)
        # print("block e3 size = %s" % (str(e3.size())))
        # print("block e4 size = %s" % (str(e4.size())))
        ...
        e6 = self.ec6(e5)
        e7 = self.ec7(e6)
        # print("block e5 size = %s" % (str(e5.size())))
        # print("block e6 size = %s" % (str(e6.size())))
